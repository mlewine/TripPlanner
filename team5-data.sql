...
Insert into attraction values(1,'Metz Cathedral', 'The Metz Cathedral is a Roman Catholic Cathedral located in the heart of Metz, France. The stained glass windows include works by Gothic and Renaissance master glass makers, such as Hermann von Munster and Theobold of Lixheim', 1, 4.50, NULL,0);
Insert into attraction values(2,'Centre Pompidou-Metz', 'The Centre Pompidou-Metz is a museum of modern and contemporary arts located in Metz, capital of Lorraine,France. It is a branch of Pompidou arts centre of Paris, and features exhibitions from the French National Museum of Modern Art.', 2, 10.00,NULL,0);
Insert into attraction values(3,'Museums of Metz', 'It is a labyrinthal organization of rooms, incorporating the ancient Petites Carmes Abbey, the Chèvremont granary, and the Trinitaires church.', 3, 5.00,NULL,0);
Insert into attraction values(4,'Eiffel Tower', 'The Eiffel Tower is a wrought iron lattice tower on the Champ de Mars in Paris, France. It is named after the engineer Gustave Eiffel, whose company designed and built the tower.', 4, 17.00,NULL,0);
Insert into attraction values(5,'Louvre', "The Louvre or the Louvre Museum is the world's largest museum and a historic monument in Paris, France. A central landmark of the city, it is located on the Right Bank of the Seine in the 1st arrondissement.", 5, 15.00,NULL,0);
Insert into attraction values(6,'Notre Dame', 'Notre Dame is a medeival catholic, and is considered to be one of the best examples of Gothic architecture in the world. Making the climb to the top of the 300 foot towers gives one of the best views in the city.', 6, 8.50,NULL,0);
Insert into attraction values(7,'58 Tour Eiffel', 'Dine in the heart of Parisian nightlife...When the sun goes down, 58 Tour Eiffel takes on a new dimension. You will be greeted by a hostess who will lead you to your table where the atmosphere of luxury will surround you', 4, 85.00,60,1);
Insert into attraction values(8,'Brunch boat cruise', 'Step on board Paris en Scène and experience our meal prepared on board according to the best bistro traditions by our chef. The only requirement is that you get comfortable in our large leather armchairs, while admiring the view of the Seine', 7, 39.00,50,1);
Insert into attraction values(9,'Colosseum', 'The Colosseum is located just east of the Roman Forum and was built to a practical design, with its 80 arched entrances allowing easy access to 55,000 spectators', 8, 15.50,NULL,0);
